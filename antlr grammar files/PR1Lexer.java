...
public class PR1Lexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "VAR", "IF", "ELSE", "WHILE", "WRITE", "FUNCTION", "READ", "RETURN", 
			"BREAK", "CONTINUE", "ASSIGN", "PLUS", "MINUS", "DIV", "MULT", "EQ", 
			"NEQ", "GT", "LT", "GTE", "LTE", "AND", "OR", "NOT", "SEMI", "LPAREN", 
	...
	public PR1Lexer(CharStream input) {
		super(input);
